...
const Header = (props) => {
  return (
    <div className='w-full h-[4rem] md:h-[3rem] bg-color6  text-black font-[nunito] flex justify-center items-center'>
            <ul className='flex flex-row  gap-6 md:gap-4 flex-wrap text-[1.2rem]'>
            <Link to='/'>
